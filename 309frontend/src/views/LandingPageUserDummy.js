    ...
    fetchResturants() {
        ...
        this.setState({
            resturants: [
                ...
                {name: "Dan's", type:"Grocery", desc: 'Some desc2', route: '/business-profile-user1'},
                {name: "Lee's", type:"Activity", desc: 'Some desc3', route: '/business-profile-user1'},
                {name: "Jack's", type:"Resturant/Bar", desc: 'Some desc4', route: '/business-profile-user1'},
            ]
        })
    }
